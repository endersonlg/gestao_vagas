...
import br.com.endersonlg.gestao_vagas.exceptions.JobNotFoundException;
...
import br.com.endersonlg.gestao_vagas.modules.candidate.entity.ApplyJobEntity;
import br.com.endersonlg.gestao_vagas.modules.candidate.repository.ApplyJobRepository;
...
public class ApplyJobCandidateUseCaseTest {
  ...
  public void should_not_be_able_to_apply_job_with_job_not_found() {
    ...
    when(candidateRepository.findById(
        idCandidate)).thenReturn(Optional.of(candidate));
  ...
  @Test
  @DisplayName("Should be able to crate a new apply job")
  public void should_be_able_to_create_a_new_apply_job() {
    var idCandidate = UUID.randomUUID();
    var idJob = UUID.randomUUID();

    when(candidateRepository.findById(
        idCandidate)).thenReturn(Optional.of(new CandidateEntity()));

    when(jobRepository.findById(
        idJob)).thenReturn(Optional.of(new JobEntity()));
